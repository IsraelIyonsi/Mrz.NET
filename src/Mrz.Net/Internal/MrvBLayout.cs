...
/// <summary>
/// Field positions for the MRV-B format: a machine-readable visa in two lines of 36 characters
/// (ICAO Doc 9303 Part 7). Line 1 and the leading fields of line 2 share the TD2 geometry, but
/// the trailing region of line 2 is a single optional-data field: an MRV carries no overall
/// composite check digit.
/// </summary>
internal static class MrvBLayout
{
    /// <summary>The fixed length, in characters, of each MRV-B line.</summary>
    internal const int LineLength = 36;

    /// <summary>The number of lines an MRV-B machine-readable zone occupies.</summary>
    ...
    /// line after the date-of-expiry check digit. Unlike TD2, there is no composite check digit
    /// occupying the final position of this region.
    /// </summary>
